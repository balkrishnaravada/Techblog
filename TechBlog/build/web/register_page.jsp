...
<html>
    ...
    <body>
        ...
        <main class=" banner-background " style="height:110vh">  
            <div class="container">
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="reg-form" action="RegisterServlet" method="POST">
                                    ...
                                    <div class="form-group">
                                        <textarea name="about" class="form-control" id="about"cols="30" rows="5" placeholder="Enter something about yourself"></textarea> 
                                    </div>
                 ...
                 $('#reg-form').on('submit', function(event)
                 {
                     ...
                     $.ajax({
                         ...
                         error: function (jqXHR, textStatus, errorThrown){
                            ...
                            swal("Something went wrong..Check Again");
